...
from lattes.pages import Curriculum, Preview, Xml

UA = UserAgent()


@pytest.mark.parametrize(
    "short_id, expected_date",
    [
...
@pytest.mark.parametrize("long_id", [None, False, "", "12345ASDF1234567"])
